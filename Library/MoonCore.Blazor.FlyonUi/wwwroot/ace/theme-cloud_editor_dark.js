define("ace/theme/cloud_editor_dark-css",["require","exports","module"],function(e,t,n){
    n.exports = `
...
define("ace/theme/cloud_editor_dark",["require","exports","module","ace/theme/cloud_editor_dark-css","ace/lib/dom"],function(e,t,n){
    t.isDark = !0;
    t.cssClass = "ace-cloud_editor_dark";
    t.cssText = e("./cloud_editor_dark-css");
    var r = e("../lib/dom");
    r.importCssString(t.cssText, t.cssClass, !1);
});

(function() {
    window.require(["ace/theme/cloud_editor_dark"], function(m) {
